...
| -------| -------| -------|
| Email: `admin@MedSync.com` | Email: `doctor@MedSync.com` |   Email: `patient@MedSync.com` | 
...
5. Create a new database naming `MedSync`.
6. Import the provided SQL file. The file is known as DATABASE MedSync.sql located inside the source code root folder.
7. Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/MedSync/.
